...
<reference>
@/data/data/com.termux/files/home/repos/lucien_bot/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/data/data/com.termux/files/home/repos/lucien_bot/.claude/get-shit-done/references/user-profiling.md` to load:
