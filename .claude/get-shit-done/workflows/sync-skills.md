...
INSTALL_JS_GLOBAL="/data/data/com.termux/files/home/repos/lucien_bot/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /data/data/com.termux/files/home/repos/lucien_bot/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
