...
```bash
INIT=$(node "/data/data/com.termux/files/home/repos/lucien_bot/.claude/get-shit-done/bin/gsd-tools.cjs" init plan-phase "$PHASE")
...
```bash
PHASE_INFO=$(node "/data/data/com.termux/files/home/repos/lucien_bot/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
```
...
```bash
node "/data/data/com.termux/files/home/repos/lucien_bot/.claude/get-shit-done/bin/gsd-tools.cjs" state planned-phase --phase "${PHASE}" --name "${phase_name}" --plans "${PLAN_COUNT}"
```
