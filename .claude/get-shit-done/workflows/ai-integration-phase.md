...
```markdown
Read /data/data/com.termux/files/home/repos/lucien_bot/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/data/data/com.termux/files/home/repos/lucien_bot/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /data/data/com.termux/files/home/repos/lucien_bot/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /data/data/com.termux/files/home/repos/lucien_bot/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /data/data/com.termux/files/home/repos/lucien_bot/.claude/agents/gsd-eval-planner.md for instructions.
