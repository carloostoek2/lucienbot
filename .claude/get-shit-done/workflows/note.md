...
- **Global scope**: `/data/data/com.termux/files/home/repos/lucien_bot/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/data/data/com.termux/files/home/repos/lucien_bot/.claude/notes/`)
...
2. Glob `/data/data/com.termux/files/home/repos/lucien_bot/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/data/data/com.termux/files/home/repos/lucien_bot/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/data/data/com.termux/files/home/repos/lucien_bot/.claude/notes/` — works in any directory
