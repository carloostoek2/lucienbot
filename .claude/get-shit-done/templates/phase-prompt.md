...
<!-- For checkpoint task examples and patterns, see @/data/data/com.termux/files/home/repos/lucien_bot/.claude/get-shit-done/references/checkpoints.md -->
...
See `/data/data/com.termux/files/home/repos/lucien_bot/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/data/data/com.termux/files/home/repos/lucien_bot/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/data/data/com.termux/files/home/repos/lucien_bot/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
