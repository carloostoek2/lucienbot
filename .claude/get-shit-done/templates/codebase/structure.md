...
- Usage: Reference from command with `@/data/data/com.termux/files/home/repos/lucien_bot/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /data/data/com.termux/files/home/repos/lucien_bot/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /data/data/com.termux/files/home/repos/lucien_bot/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
