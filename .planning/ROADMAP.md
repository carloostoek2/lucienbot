...
Plans:
- [ ] 11-01: Wave 0 — Test infrastructure: fixtures, e2e marker, stub files
- [ ] 11-02: StoreService — Unit tests + race condition fix (SELECT FOR UPDATE)
...
- [ ] 11-05: UserService + AnalyticsService + StoryService — Unit tests
