...
def upgrade() -> None:
    ...
    # PostgreSQL: upgrade INTEGER columns to BigInteger for higher scale
    # SQLite: INTEGER is already 64-bit, no alter needed
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    # PostgreSQL: downgrade BigInteger back to INTEGER
    # SQLite: no alter needed (INTEGER is already 64-bit)
    if context.get_context().dialect.name != 'sqlite':
        op.alter_column('broadcast_reactions', 'besitos_awarded',
